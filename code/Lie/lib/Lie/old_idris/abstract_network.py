...
class AbstractNetwork(Network):
    def __init__(self, n_inpt, n_classes, inpt_shape, dt=1.0):
    ...
    def to(self, device=None, *args, **kwargs):
        ...
        self.ngram_scores_3 = {
            k: v.to(device=device) for k, v in self.ngram_scores_3.items()
        }
    ...
    def save(self, filepath):
        ...
        torch.save(self.ngram_scores_3, open(os.path.join(filepath, "3gram.pt"), "wb"))
