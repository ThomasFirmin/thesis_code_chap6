...
from lave.optim_conv import ConvSHDExtended
...
from search_spaces import get_shd_lava_cnt_conv
...
parser.add_argument("--save", type=str, default="test_casbo_shd_conv")
...
path = f"/home/thfirmin/ext_shd/torch_extension_shd_conv_{loss.rank}"
