...
parser.add_argument("--save", type=str, default="test_casbo_dvs")
...
model = Objective(
    ...
    beta_test=0.3,
    gpu=gpu,
    early_stopping=NonSpikingPercentageStopping("outpt", 1, 0.3),
    weight_norm=True,
    max_epochs=15,
)
...
path = f"/home/thfirmin/ext_dvs/torch_extension_dvs_{loss.rank}"
...
exp = Experiment(bo, loss, stop, save="test_casbo_dvs")
exp.run()
