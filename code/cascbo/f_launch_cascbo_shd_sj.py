...
from geleeepicee.optim_conv import FfSHD
...
from search_spaces import get_shd_spikingjelly_cnt
...
parser.add_argument("--save", type=str, default="test_casbo_shd_sj")
...
# Decision variables
values = get_shd_spikingjelly_cnt()
