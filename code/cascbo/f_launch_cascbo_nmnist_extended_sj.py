...
from geleeepicee.optim_conv import ConvMNISTExt
...
from search_spaces import get_mnist_rate_spikingjelly_cnt_extended
...
parser.add_argument("--save", type=str, default="test_casbo_nmnist_ext_sj")
...
# Decision variables
values = get_mnist_rate_spikingjelly_cnt_extended()
