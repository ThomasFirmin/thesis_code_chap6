...
from geleeepicee.optim_conv import ConvMNIST
...
from search_spaces import get_mnist_rate_spikingjelly_cnt
...
parser.add_argument("--save", type=str, default="test_casbo_nmnist_sj")
...
# Decision variables
values = get_mnist_rate_spikingjelly_cnt()
